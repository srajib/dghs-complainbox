	...
	var methods = {	        
		...
		close : function(){
			jQuery.fallr('show', {
				closeKey : true,
				closeOverlay : true,
				content : '<p>Click on overlay or press ESC to close thikhkjshdkjsd
				sdjkljsdkljskldjkl
				sjdkljskldjklsjdkls
				sdl;skjdljskldjklb skjdbhjsd sjdghjgsdhj sjgdhj gsdj shkdhkjs hskjdhkjs s message</p>',
				icon: 'info'
			});
		},
		effect : function(){
		...
		autoresize : function(){
			...
			var bigger = function(){
				jQuery.fallr('resize', {width: '800px', height: '900px'});
			};
			jQuery.fallr('show', {
